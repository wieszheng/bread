...
class TestCaseOutParameters(BaseModel):
    ...
    name: Mapped[str] = mapped_column(String(24), nullable=False, comment="参数名")
    ...
    expression: Mapped[str] = mapped_column(String(128), comment="表达式")
    # 获取结果索引, 可以是random，也可以是all，还可以是数字
    match_index: Mapped[str] = mapped_column(String(16), comment="主键ID")
